...
<div class="row">
    <div class="col-lg-12 grid-margin">
        <div class="card">
            <div class="card-body">
                <h1 class="card-title">Menampilkan Data Film</h1>
                <p>
                    Endpoint ini memungkinkan Anda untuk mengakses data film
                    yang ada dengan memasukkan parameter tertentu seperti
                    <code>title</code>, <code>genre</code>,dan <code>language</code>.
                    Parameter tidak wajib dimasukkan. Jika tidak ada parameter
                    yang dimasukkan, endpoint akan menampilkan semua data film.
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    >
                                        <td>GET</td>
                                        <td>
                                            http://localhost/endpoint/movies.php
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        },
        {
            ...
            "rating_film": 4.2
                    ...
                    <div
                        ...
                        id="fail"
                        role="tabpanel"
                        aria-labelledby="fail-tab"
                    >
                        <!-- Isi dengan contoh response gagal -->
                        <style>
                            .json-container {
                                position: relative;
                                background-color: #ffffff;
                            ...
                            <pre><code>
{
    "status": {
        ...
        "description": "Invalid API Key"
                    ...
                    >
                        <!-- Isi dengan penjelasan response -->
                        <div class="card-body">
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    >
                                        <td>result</td>
                                        <td>array</td>
                                        <td>Informasi tambahan dari respons</td>
                                    </tr>
                                    <tr
                                        data-widget="expandable-table"
                                        aria-expanded="true"
                                    >
                                        <td>id_movies</td>
                                        <td>int</td>
                                        <td>ID dari film yang dinilai</td>
                                    </tr>
                                    <tr
                                        data-widget="expandable-table"
                                        aria-expanded="true"
                                    ...
                                    >
                                        ...
                                        <td>int</td>
                                        <td>
                                            Penilaian dari pengguna untuk film
                                            tersebut
                                        </td>
                                    </tr>
                                </tbody>
